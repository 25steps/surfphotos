...
import static com.drew.surfphotos.web.security.SecurityUtils.TEMP_PROFILE;

/**
 * Используется для того, что бы сказать, что регистрируется временный пользователь
 *
 */
